from src.ingestion.tg import format_jsonl, extract_all_messages, combine_messages, handle_user_order
from os import getenv
from dotenv import load_dotenv
#from src.tests.tg_test_utils import 
...
#message_list = handle_user_order(extract_all_messages("src/tests/test_logs/basic_receive_message.json"))
